...
class ServiceVC: UITableViewController {
    ...
    let serviceDataSet = ServiceDataSet()
    

    override func viewDidLoad() {
        super.viewDidLoad()
        
        //ServiceCell.configureServiceCell()
